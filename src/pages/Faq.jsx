...
const groups = [
  {
    ...
    items: [
      ...
      ['Is there a Shopify app for UGC video?', 'Yes. AnotherDev Shoppable Video makes UGC video shoppable on Shopify. Upload creator clips, customer reviews or social reels, link each one to the product it features, and place it on any page with an Add to Cart button, so user-generated video becomes a buying moment.'],
      ['Can I turn Instagram reels and TikToks into shoppable video?', 'Yes. Download the reel or TikTok you have the rights to use, upload the file to your Shopify Files, select it in AnotherDev, and link it to a product. The clip then shows on your store as shoppable video with a live price and Add to Cart.'],
      ['What should I look for in a shoppable video app for Shopify?', 'Look for add to cart inside the video, placements on every page type (home, collection, product and a floating player), correct live pricing in each currency, no theme code edits, support for your cart app, lazy loading so it does not slow your store, and per-video analytics. AnotherDev Shoppable Video is built around all of these.'],
